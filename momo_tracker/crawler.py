...
async def crawl_promos(browser: Browser):
    promotion_items: List[PromotionItem] = []
    page = await browser.new_page()
    await page.goto("https://www.momoshop.com.tw/edm/cmmedm.jsp?lpn=O1K5FBOqsvN&n=1")
...
async def fetch_item_object(browser: Browser, item_url: str) -> Item:
    page = await browser.new_page()
